# Vendored from jirutka/zsh-shift-select (MIT). DO NOT HAND-EDIT.
# Upstream: https://github.com/jirutka/zsh-shift-select
# Pinned:   tag v0.1.1 (commit 47296f18c52e9cdff5ddf0c28a5cc8c88ef8696e)
# Upstream raw sha256 (zsh-shift-select.plugin.zsh at the pinned commit): 0c650391382d84de693cd738eca51644923803a515c6d5f2d049c243da79b82e
# This copy only prepends this header; the body below is byte-verbatim upstream.
# Bump: re-download https://raw.githubusercontent.com/jirutka/zsh-shift-select/<tag>/zsh-shift-select.plugin.zsh, refresh the sha256, update this header.
# Sourced from ~/.zshrc; supplemented there (replace-on-type, OSC 52 copy).
#
# vim: set ts=4:
