...
- The luaparse gate ([[feedback-lua-syntax-use-luaparse-not-lsp]]) catches *syntax*, not a runtime deadlock — there's no parse-time signal for this, so the rule above is the guard.
